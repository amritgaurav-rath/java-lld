...
public class GameController {
    ...
    public void takeTurn(Player p) {
        ...
        Connector connector = board.getConnector(nextPosition);
        if(connector != null) {
            System.err.println(connector.getEncounterMessage());
            nextPosition = connector.getEnd();
        }
        p.setPosition(nextPosition);
    ...
    public static class Builder {
        ...
        public Builder setDice(int maxFaces) {
            this.dice = new Dice(maxFaces);
